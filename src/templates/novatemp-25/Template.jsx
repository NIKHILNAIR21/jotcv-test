  ...
  return (
    <div className="p-5 ">
      ...
      <header className="flex justify-between item-start">
        <div>
          <h1 className="text-xl capitalize font-semibold text-purple-600">
            {resumeData?.full_name}
          </h1>
          <h4 className="text-base capitalize font-semibold text-purple-600">
            {resumeData?.position}
          </h4>
        </div>
      ...
      {/* experinece */}
      <div className="mt-1">
        <h2 className="text-base text-purple-600 font-semibold">Experience</h2>
        {/* exp */}
      ...
      {/* Projects */}
      <div className="mt-1">
        <h2 className="text-base text-purple-600 font-semibold">Projects</h2>
        {/* exp */}
      ...
      {/* education */}
      <div className="mt-2">
        <h2 className="text-base text-purple-600 font-semibold">Education</h2>
        {/* exp */}
      ...
      <div className="flex justify-between item-start gap-2">
        ...
        <div className="mt-1 w-[50%]">
          <h2 className="text-base text-purple-600 font-semibold">Skill</h2>
        ...
        {/* interest */}
        <div className="mt-1 w-[50%]">
          <h2 className="text-base text-purple-600 font-semibold">interests</h2>
          <div className="flex flex-wrap gap-2 ">
      ...
      <div className="mt-2 w-[50%]">
          <h2 className="text-base text-purple-600 font-semibold">Language</h2>
          <div className="flex flex-wrap gap-2">
         ...
         {/* certificate */}
        <div className="mt-1 w-[50%]">
          <h2 className="text-base text-purple-600  font-semibold">Certification</h2>
