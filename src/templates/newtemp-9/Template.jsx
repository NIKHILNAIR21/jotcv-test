  ...
  return (
    <div className="A4 ">
      <div className="w-[96%]  h-full  bg-white  ">
        <header className="text-center flex bg-blue-700 justify-between text-white h-fit  py-0.5">
        ...
        <section className="my-1 px-2 ">
          <h2 className="text-xl text-blue-700 font-semibold">Summary</h2>
          <p className="text-[12px] w-fit p-0.5 border-r-2 border-l-2 border-blue-700 rounded font-medium">
            {resumeData?.summary}
          </p>
        </section>
        ...
        <section className="my-1 px-2">
          ...
          <div className="flex flex-wrap justify-start gap-3 ">
            {resumeData?.experiences.map((exp, index) => (
              <div
                key={exp.id}
                className="mt-1 w-56 p-1.5 text-justify  border-r-2 border-l-2 border-blue-700  rounded-md"
              >
        ...
        <section className="my-1 px-2">
          <h2 className="text-xl text-blue-700 font-semibold">Education</h2>

          <div className="flex flex-wrap justify-start gap-4 ">
            {resumeData?.eductaions?.map((edu, index) => (
              <div
                key={edu.id}
                className="mt-1 p-1.5 w-fit border-r-2 border-l-2 border-blue-700 rounded"
              >
        ...
        <section className="my-1 px-2">
          <h2 className="text-xl text-blue-700 font-semibold">Projects</h2>
          ...
          <div className="flex flex-wrap justify-start gap-4">
            {resumeData.projects.map((project, index) => (
              <div key={index} className="mt-1 w-64">
                <a
                  href={project.link}
                  className="text-lg bg-blue-700 p-0.5 rounded text-white font-medium"
                >
                  {project.title}
                </a>
        ...
        <div className="flex justify-evenly">
          <section className="my-1 px-2 w-[50%]">
            <h2 className="text-xl text-blue-700 font-semibold">Skills</h2>
          ...
          <section className="my-1 px-2 w-[50%]">
            <h2 className="text-2xl text-blue-700 font-semibold">Interests</h2>
            <p className="flex flex-wrap   gap-3">
        ...
        <div className="flex justify-evenly">
          ...
          <section className="my-1 px-2 w-[50%]">
            <h2 className="text-xl text-blue-700 font-semibold">Languages</h2>
            <div className="flex flex-wrap justify-start gap-4">
        ...
        <section className="my-1 px-2">
          <h2 className="text-xl text-blue-700 font-semibold">Video Profile</h2>
