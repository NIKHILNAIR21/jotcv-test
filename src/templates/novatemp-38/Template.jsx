      ...
      <>
        ...
        <div className="px-2">
          <header className="flex justify-start gap-x-6 items-start">
            ...
            <div>
              <h1 className="font-semibold text-[#023B63] text-xl">
                {" "}
                {resumeData?.full_name}
              </h1>
              <h3 className="font-medium text-[#023B63] text-base">
                {resumeData?.position}
              </h3>
          ...
          <section className="flex gap-10 justify-between">
              ...
              <div>
                ...
                {resumeData?.experiences?.map((exp, index) => (
                  <div className="mt-1 p-1 text-justify">
                    <h3 className="text-sm text-white w-fit p-1 rounded-lg bg-[#023B63] font-semibold">
                      {exp?.company_name}
                    </h3>
                ...
                <div>
                  ...
                  <div>
                    {resumeData?.projects?.map((project) => (
                      <div className="mt-1 p-1 text-justify">
                        <h3 className="text-sm text-white bg-[#023B63] w-fit p-1 rounded-md font-semibold">
                          {project?.title}
                        </h3>
                        <div className="flex gap-2">
                          <a href= {project?.link}
                  ...
                  <div>
                    {resumeData?.eductaions.map((edu, index) => (
                      <div className="mt-1 p-1.5 rounded">
                        <div />
                        <h3 className="text-sm bg-[#023B63] text-white p-1 rounded-lg w-fit font-medium">
                          {edu?.university}
                        </h3>
            ...
            <div className="w-[50%]">
              <div className=" flex flex-col">
                <div className="bg-[#E4E7EC] mt-10  rounded-md w-fit p-1">
                ...
                {/* languages */}
                <div className="p-1 bg-[#E4E7EC] rounded-md w-fit mt-10">
                  <h1 className="font-semibold uppercase text-base mt-1 ">
                    Language
                  </h1>
                ...
                {/*  certificates*/}
                <div className="w-fit bg-[#E4E7EC] rounded-md p-1 mt-10">
