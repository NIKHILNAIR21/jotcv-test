...
const Template = () => {
  ...
  return (
    <div className="A4 ">
      ...
      <p className="w-[90%] mx-auto bg-gray-400 h-1"></p>
        <p className="w-[90%] mx-auto bg-amber-700/50  h-1"></p>
        <p className="w-[90%] mx-auto bg-sky-600 h-1"></p>
      </div>
            ...
            {resumeData?.projects?.map((exp, index) => (
              <div key={exp?.id} className="mt-1  p-1.5 text-justify">
                ...
                <div className="flex justify-between ">
                  ...
                  <p className="text-xs w-[25%] text-right text-black">
