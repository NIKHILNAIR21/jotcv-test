      ...
      <div className="w-[96%]  h-full  bg-white  ">
        ...
        >
          ...
          <div className="flex  flex-col  justify-start  text-right   items-end ">
            ...
            <div className="p-2 bg-orange-500 flex items-center text-black rounded-md mx-2">
        ...
        <section className="my-1 px-2 ">
          <h2 className="text-xl text-orange-500 font-semibold">Summary</h2>
        ...
        <section className="my-1 px-2">
          ...
          <div className="flex flex-wrap justify-start gap-3 ">
            {resumeData?.experiences.map((exp, index) => (
              <div
                key={exp?.id}
                className="mt-1 w-56 p-2 text-justify bg-black rounded-md"
              >
                <h3 className="text-base text-white font-medium">
                  {exp?.company_name}
                </h3>
                <p className="text-base text-white">{exp?.designation}</p>
        ...
        <section className="my-1 px-2">
          <h2 className="text-xl text-orange-500 font-semibold">Education</h2>
        ...
        <section className="my-1 px-2">
          <h2 className="text-xl text-orange-500 font-semibold">Projects</h2>
        ...
        <div className="flex justify-evenly">
          <section className="my-1 px-2 w-[50%]">
            <h2 className="text-xl text-orange-500 font-semibold">Skills</h2>
        ...
        <div className="flex justify-evenly">
          ...
          <section className="my-1 px-2 w-[50%]">
            <h2 className="text-xl text-orange-500 font-semibold">Languages</h2>
            <div className="flex flex-wrap justify-start gap-4">
