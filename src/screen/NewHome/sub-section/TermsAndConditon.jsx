  ...
  return (
    <>
      <header className="mt-10">
        <h1 className="text-2xl sm:text-5xl text-center font-sans">Terms & Conditions</h1>
      </header>
      <main className=" mx-5 sm:mx-20 lg:mx-32 my-7">
        <section>
          <header>
            <h3 className="text-xl font-poppins font-semibold">OVERVIEW</h3>
          </header>
          <section>
            <article className="text-justify font-sans py-1">
              This website is operated by Redclip Technologies Pvt. Ltd..
              Throughout the site, the terms “we”, “us” and “our” refer to
              Redclip Technologies Pvt. Ltd.. Redclip Technologies Pvt. Ltd.
        ...
        <section className="mt-3">
          ...
          <section>
            <article className="text-justify font-sans py-1">
              ...
              at least the age of majority in your state or country of
              residence, or that you are the age of majority in your state or
              country of residence and you have given us your consent to allow
        ...
        <section className="mt-3">
          ...
          <section>
            <article className="text-justify font-sans py-1">
              ...
              payment mode, and/or orders that use the same billing and/or
              shipping address. If we make a change to or cancel an order, we
            ...
            <article className="text-justify font-sans py-1">
              ...
              your email address, payment mode, credit card details and
        ...
        <section className="mt-3">
          ...
          <section>
            <article className="text-justify font-sans py-1">
              You may purchase a paid subscription directly from JotCv by
              paying a subscription fee in advance every month or some other
              recurring interval disclosed to you before your purchase.
            </article>
            <article className="text-justify font-sans py-1">
              For recurring charges applicable to your subscription, you agree
              that third parties working on our behalf may store your payment
              information to process the payments. The subscription fee for the
               service will be charged to your Payment Method on the
              specific payment date indicated on the "Account-Profile" page.
              <br /> If a payment is not successfully settled, due to
            ...
            <article className="text-justify font-sans py-1">
              JotCv may change the price for the paid subscriptions,
              including recurring subscription fees, from time to time, and will
              communicate any price changes to you in advance and, if
              applicable, how to accept those changes. Price changes will not
              affect your subscription price if you are already subscribed. In
              case you want to switch to new pricing, you’ll have to cancel the
              current subscription and create a new one with new pricing.
            </article>
          </section>
        </section>
        <section className="mt-3">
          ...
          <section>
            <article className="text-justify font-sans py-1">
              Your payment to JotCv will automatically renew at the end of
              the applicable subscription period unless you cancel your paid
              subscription before the end of the then-current subscription.
            </article>
            <article className="text-justify font-sans py-1">
              You can cancel your subscription at any time, and you will
              continue to have access to the JotCv service through the end
              of your subscription period. The cancellation will take effect the
              day after the last day of the current subscription period and you
              will be downgraded to the Free Service.
            </article>
            <article className="text-justify font-sans py-1">
              To cancel, go to the "Account-Login" page select the subscription
              you wish to cancel and proceed by clicking on the Cancel button.
            </article>
          </section>
        </section>
        <section className="mt-3">
          <header>
            <h3 className="text-xl font-poppins font-semibold">Refunds</h3>
          </header>
          <section>
            <article className="text-justify font-sans py-1">
              ...
              already paid to us. When we process any refund, we will refund the
              amounts using the method you used for payment.
            </article>
            <article className="text-justify font-sans py-1">
              In the unfortunate event of the software, apps, applications or
              servers crashing or having technical problems during your purchase
              or any technical issue on our side that prevented you from
              cancelling or using our services entirely please email us at
              info@jotcv.com, and the problem will be investigated. This
              will result in refunds in the case we find the problem was caused
              on our end.
            </article>
            <article className="text-justify font-sans py-1">
              If by any chance you encounter problems, and you're not happy with
              the final result, do not hesitate to contact us at
              info@jotcv.com, and our team will get back to you on what
              could be done in your case.
            </article>
          </section>
        </section>
        <section className="mt-3">
          ...
          <article className="text-justify font-sans py-1">
            ...
            neither monitor nor have any control or input. You acknowledge and
            agree that we provide access to such tools ”as is” and “as
            available” without any warranties, representations or conditions of
            any kind and any endorsement. We shall have no liability whatsoever
          ...
          <article className="text-justify font-sans py-1">
            In the future, we may also offer new services and/or features
        ...
        <section className="mt-3">
          ...
          <article className="text-justify font-sans py-1">
            ...
            warrant. We will not have any liability or responsibility for any
            third-party materials or websites, or for any other materials,
            products, or services of third parties. <br /> We are not liable for
        ...
        <section className="mt-3">
          ...
          <section>
            ...
            <article className="text-justify font-sans py-1">
              In no case shall Redclip Technologies Pvt. Ltd., our directors,
        ...
        <section className="mt-3">
          <header>
            <h2 className="font-bold text-xl mb-4">INDEMNIFICATION</h2>
          </header>
          <section>
            <article className="text-justify font-sans py-1">
              You agree to indemnify, defend and hold harmless Redclip
              Technologies Pvt. Ltd. and our parent, subsidiaries, affiliates,
        ...
        <section className="mt-3">
          <header>
            <h3 className="text-xl font-poppins font-semibold">SEVERABILITY</h3>
          </header>
          <section>
            <article className="text-justify font-sans py-1">
        ...
        <section className="mt-3">
          <header>
            <h3 className="text-xl font-poppins font-semibold">TERMINATION</h3>
          </header>
          <section>
            <article className="text-justify font-sans py-1">
        ...
        <section className="mt-3">
          ...
          <section>
            ...
            <article className="text-justify font-sans py-1">
              ...
              by us on this site or in respect to The Service constitute the
        ...
        <section className="mt-3">
          ...
          <section>
            <article className="text-justify font-sans py-1">
              ...
              accordance with the laws of India and jurisdiction of Aurangabad,
              Bihar
            </article>
          </section>
        </section>
        <section className="mt-3">
          ...
          <section>
            <article className="text-justify font-sans py-1">
              These Terms of Service and any separate agreements whereby we
              provide you Services shall be governed by and construed in
              accordance with the laws of India and jurisdiction of Raipur
            </article>
          </section>
        </section>
        <section className="mt-3">
          <header>
            <h3 className="text-xl font-poppins font-semibold">Voice Call</h3>
          </header>
          <section>
            <article className="text-justify font-sans py-1">
              ...
              further authorize the Company to share/disclose the information to
              any third party service provider or any affiliates, group
        ...
        <section className="mt-3">
          ...
          <section>
            <article className="text-justify font-sans py-1">
             ...
             <span className="font-semibold text-sky-500 px-1.5">
             info@jotcv.com
             </span> 
            </article>
          </section>
